          ...
          <div class="card group">
            ...
            <div class="card-h">
              ...
              <div class="action-dock">
                ...
                <a
                  v-if="selectedDoc"
                  :href="`/documents/school-properties/${selectedDoc.id}/download`"
                  class="dock-btn"
                  title="Download"
                >
                ...
                <button
                  ...
                  @click="selectedDoc && openDeleteModal(selectedDoc)"
            ...
            <div class="grid-wrap density-compact">
              ...
              >
                ...
                <div class="g-actions" @click.stop>
                  ...
                  <a
                    :href="`/documents/school-properties/${doc.id}/download`"
                    class="icon"
                    title="Download"
                  >
                    <i class="bi bi-download"></i>
                  </a>
                  <button class="icon danger" title="Delete" @click="openDeleteModal(doc)">
                    <i class="bi bi-trash"></i>
                  </button>
                </div>
              </div>
...
function confirmDelete() {
  ...
  router.delete(`/documents/school-properties/${id}`, {
    preserveScroll: true,
    replace: true,
    onSuccess: () => {
...
.tool-grid { display: grid; grid-template-columns: 1fr; gap: 0.625rem; }
...
.g-thumb { display: grid; place-items: center; height: 6rem; overflow: hidden; border: 1px solid #eef0f5; border-radius: 0.625rem; }
.g-thumb img { width: 100%; height: 100%; object-fit: cover; }
.g-fallback { color: #667085; font-size: 1.625rem; }
.g-name { font-weight: 600; font-size: 0.8125rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.g-sub { display: flex; gap: 0.375rem; align-items: center; }
.g-actions { display: flex; gap: 0.375rem; margin-top: 0.125rem; }
.icon { background: transparent; border: 0; font-size: 1.125rem; cursor: pointer; color: #374151; }
...
/* Pagination */
.pagination { display: flex; justify-content: center; gap: 0.375rem; margin: 0.75rem 0 0.25rem; }
.page-link { padding: 0.375rem 0.625rem; border: 1px solid #d1d5db; border-radius: 0.625rem; background: #fff; cursor: pointer; }
.page-link.active { background: #19184f; color: #fff; }
.page-link.disabled { background: #eee; color: #aaa; }

/* ===== Simple Modals (shared) ===== */
.preview-modal {
  position: fixed;
  inset: 0;
  z-index: 2147483647;
